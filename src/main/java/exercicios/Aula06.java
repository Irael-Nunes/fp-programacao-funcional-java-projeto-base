...
public class Aula06 extends Aula {
    ...
    public List<Estudante> getEstudantesMulheresAprovadasOrdenadasPorCursoAndNota() {
        return estudantes.stream()
                .filter(mulheresAprovadas)
                .sorted(Comparator.comparing((Estudante e) -> e.getCurso().getNome()).thenComparingDouble(Estudante::getNota))
                .toList();
    }
    ...
    public List<Estudante> getEstudantesMulheresAprovadasOrdenadasPorCursoDecrescenteAndNotaCrescente() {
        return estudantes.stream()
                .filter(mulheresAprovadas)
                .sorted(Comparator.comparing((Estudante e) -> e.getCurso().getNome(), Comparator.reverseOrder()).thenComparingDouble(Estudante::getNota))
                .toList();
    }
    ...
    public List<Estudante> getEstudantesMulheresAprovadasOrdenadasTotalmenteDecrescente() {
        return estudantes.stream()
                .filter(mulheresAprovadas)
                .sorted(Comparator.comparing((Estudante e) -> e.getCurso().getNome()).thenComparingDouble(Estudante::getNota).reversed())
                .toList();
    }
    ...
    public List<Estudante> getEstudantesMulheresAprovadasOrdenadasPorCursoCrescenteAndNotaDecrescente() {
        return estudantes.stream()
                .filter(mulheresAprovadas)
                .sorted(Comparator.comparing((Estudante e) -> e.getCurso().getNome()).thenComparingDouble(e -> -e.getNota()))
                .toList();
    }
}
